...
export default function ExpandableCardDemo() {
    ...
    return (<>
        ...
        <ul className="max-w-2xl mx-auto w-full gap-4 bg-gray-500 rounded-2xl my-auto md:mt-1 sm:mt-10 p-4">
...
const cards = [
    {
        ...
        src: firstWebsite,
        ctaText: "View",
        ctaLink: "https://jrvs26.github.io/random",
        content: () => {
            return (
                (<p>Admitting that I admire her.
                </p>)
            );
        },
    },
...

    {
        ...
        src: thirdWebsite,
        ctaText: "View",
        ctaLink: "https://jrvs26.github.io/airish",
        content: () => {
            return (
